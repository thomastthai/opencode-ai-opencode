...
**IMPORTANT**: Refer to [TESTING.md](./docs/development/TESTING.md) for comprehensive testing guidelines, patterns, and lessons learned from production bugs. Key principles:
...
Refer to [GIT.md](./docs/development/GIT.md) for git workflow and commit message guidelines.

## Referenced Documentation

- **[ARCHITECTURE.md](./docs/development/ARCHITECTURE.md)**: Core architecture patterns and coding principles
- **[TESTING.md](./docs/development/TESTING.md)**: Comprehensive testing guidelines and patterns
- **[GIT.md](./docs/development/GIT.md)**: Git workflow and commit guidelines